                ...
                ? transactions.map((t, index) => (
                    <TableRow key={`categorized-${index}`}>
                      ...
                      <TableCell>
                        <Badge
                          variant={
                            t.category === "Income" ? "default" : "secondary"
                          }
                      ...
                      <TableCell
                        className={`text-right font-semibold ${getAmountStyle(
                          t.category
                        )}`}
                      >
                      ...
                      <TableCell className="text-center">
                        <div className="flex gap-1 justify-center">
                          ...
                          <Button
                            ...
                            title={`Change to ${
                              t.category === "Income" ? "Expense" : "Income"
                            }`}
                          >
                      ...
                      <TableCell className="text-center">
                        <div className="flex gap-1 justify-center">
                          ...
                          <Button
                            ...
                            variant="outline"
                            onClick={() =>
                              onApproveMaybeTransaction?.(index, "Income")
                            }
                          ...
                          <Button
                            ...
                            variant="outline"
                            onClick={() =>
                              onApproveMaybeTransaction?.(index, "Expenses")
                            }
                            className="h-6 w-6 p-0 bg-red-500/10 hover:bg-red-500/20 border-red-500/20"
